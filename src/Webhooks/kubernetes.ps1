...
# --------------------------------------------------------------
$DEPLOYMENT = "staging/apps/webhooks/deployment.yml"
$JOBTEMPLATE = "staging/apps/webhooks/job_webhooks.yml"
$APP = "webhooks"
...
yq '.webhooks.image = env(TAG)' -i ../../OPS/staging/config/releases.yaml
