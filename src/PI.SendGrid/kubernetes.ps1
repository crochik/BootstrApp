...
# --------------------------------------------------------------
$DEPLOYMENT="staging/apps/sendgrid/deployment.yml"
$JOBTEMPLATES = @(
    "staging/apps/sendgrid/job_bulk_email_send.yml"
)
$APP="sendgrid"
...
yq '.sendgrid.image = env(TAG)' -i ../../OPS/staging/config/releases.yaml 
