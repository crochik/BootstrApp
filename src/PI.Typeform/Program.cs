...
namespace PI.Typeform;

public class Program : MicroserviceApp
{
    protected override string Name => "Typeform";
    ...
    protected override void AddServices(IServiceCollection services)
    {
        ...
        services
            // .AddSingleton<Shared.Services.AuthorizationService>()
            // .AddSingleton<Shared.Services.AppointmentSchedulerService>()
            .AddObjectTypeService()
            ;
        
        services.AddSingleton<IDataProtectionServiceProvider, MicrosoftDataProtectionServiceProvider>();

        services.AddSingleton<TypeformClient>();
    }
}