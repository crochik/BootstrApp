...
public class MergeTemplateResponseFieldsItem
{
    /// <summary>
    ...
    public MergeTemplateResponseFieldsItemPreferences? Preferences { get; set; }

    /// <summary>
    /// List of areas where the field is located in the document.
    /// </summary>
    [JsonPropertyName("areas")]
    public required List<MergeTemplateResponseFieldsItemAreasItem> Areas { get; set; }
