...
public class CreateTemplateFromDocxRequestDocumentsItemFieldsItem
{
    /// <summary>
    /// Name of the field.
    /// </summary>
    ...
    public List<CreateTemplateFromDocxRequestDocumentsItemFieldsItemAreasItem>? Areas { get; set; }
