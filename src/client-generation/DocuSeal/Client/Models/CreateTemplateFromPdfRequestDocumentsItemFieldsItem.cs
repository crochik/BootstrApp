...
public class CreateTemplateFromPdfRequestDocumentsItemFieldsItem
{
    /// <summary>
    /// Name of the field.
    /// </summary>
    ...
    public List<CreateTemplateFromPdfRequestDocumentsItemFieldsItemAreasItem>? Areas { get; set; }
