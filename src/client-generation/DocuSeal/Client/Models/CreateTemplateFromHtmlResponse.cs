...
public class CreateTemplateFromHtmlResponse
{
    /// <summary>
    ...
    public required List<CreateTemplateFromHtmlResponseSchemaItem> Schema { get; set; }

    /// <summary>
    /// List of fields to be filled in the template.
    /// </summary>
    [JsonPropertyName("fields")]
    public required List<CreateTemplateFromHtmlResponseFieldsItem> Fields { get; set; }

    [JsonPropertyName("submitters")]
    public required List<CreateTemplateFromHtmlResponseSubmittersItem> Submitters { get; set; }
    ...
    public required CreateTemplateFromHtmlResponseAuthor Author { get; set; }

    /// <summary>
    /// List of documents attached to the template.
    /// </summary>
    [JsonPropertyName("documents")]
    public required List<CreateTemplateFromHtmlResponseDocumentsItem> Documents { get; set; }
