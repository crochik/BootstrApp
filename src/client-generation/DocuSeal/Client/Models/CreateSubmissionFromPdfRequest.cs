...
public class CreateSubmissionFromPdfRequest
{
    ...
    public required List<CreateSubmissionFromPdfRequestDocumentsItem> Documents { get; set; }

    /// <summary>
    /// The list of submitters for the submission.
    /// </summary>
    [JsonPropertyName("submitters")]
    public required List<CreateSubmissionFromPdfRequestSubmittersItem> Submitters { get; set; }
