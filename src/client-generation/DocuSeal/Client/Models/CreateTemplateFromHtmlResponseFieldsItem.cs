...
public class CreateTemplateFromHtmlResponseFieldsItem
{
    /// <summary>
    ...
    public CreateTemplateFromHtmlResponseFieldsItemPreferences? Preferences { get; set; }

    /// <summary>
    /// List of areas where the field is located in the document.
    /// </summary>
    [JsonPropertyName("areas")]
    public required List<CreateTemplateFromHtmlResponseFieldsItemAreasItem> Areas { get; set; }
