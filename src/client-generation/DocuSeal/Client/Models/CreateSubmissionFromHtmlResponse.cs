...
public class CreateSubmissionFromHtmlResponse
{
    /// <summary>
    ...
    public required List<CreateSubmissionFromHtmlResponseSubmittersItem> Submitters { get; set; }
    ...
    public List<CreateSubmissionFromHtmlResponseSchemaItem>? Schema { get; set; }

    /// <summary>
    /// List of fields to be filled in the one-off submission.
    /// </summary>
    [JsonPropertyName("fields")]
    public List<CreateSubmissionFromHtmlResponseFieldsItem>? Fields { get; set; }
