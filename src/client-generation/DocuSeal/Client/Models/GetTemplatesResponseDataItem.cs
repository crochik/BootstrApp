...
public class GetTemplatesResponseDataItem
{
    /// <summary>
    ...
    public required List<GetTemplatesResponseDataItemSchemaItem> Schema { get; set; }

    /// <summary>
    /// List of fields to be filled in the template.
    /// </summary>
    [JsonPropertyName("fields")]
    public required List<GetTemplatesResponseDataItemFieldsItem> Fields { get; set; }

    [JsonPropertyName("submitters")]
    public required List<GetTemplatesResponseDataItemSubmittersItem> Submitters { get; set; }
    ...
    public required GetTemplatesResponseDataItemAuthor Author { get; set; }

    /// <summary>
    /// List of documents attached to the template.
    /// </summary>
    [JsonPropertyName("documents")]
    public required List<GetTemplatesResponseDataItemDocumentsItem> Documents { get; set; }
