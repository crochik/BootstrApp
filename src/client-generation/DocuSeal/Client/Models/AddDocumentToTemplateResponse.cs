...
public class AddDocumentToTemplateResponse
{
    /// <summary>
    ...
    public required List<AddDocumentToTemplateResponseSchemaItem> Schema { get; set; }

    /// <summary>
    /// List of fields to be filled in the template.
    /// </summary>
    [JsonPropertyName("fields")]
    public required List<AddDocumentToTemplateResponseFieldsItem> Fields { get; set; }

    [JsonPropertyName("submitters")]
    public required List<AddDocumentToTemplateResponseSubmittersItem> Submitters { get; set; }
    ...
    public required AddDocumentToTemplateResponseAuthor Author { get; set; }

    /// <summary>
    /// List of documents attached to the template.
    /// </summary>
    [JsonPropertyName("documents")]
    public required List<AddDocumentToTemplateResponseDocumentsItem> Documents { get; set; }
