...
public class CreateSubmissionFromPdfResponse
{
    ...
    public required List<CreateSubmissionFromPdfResponseSubmittersItem> Submitters { get; set; }
    ...
    public List<CreateSubmissionFromPdfResponseSchemaItem>? Schema { get; set; }

    /// <summary>
    /// List of fields to be filled in the one-off submission.
    /// </summary>
    [JsonPropertyName("fields")]
    public List<CreateSubmissionFromPdfResponseFieldsItem>? Fields { get; set; }
