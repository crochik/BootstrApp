...
public class GetSubmitterResponse
{
    ...
    public required GetSubmitterResponseTemplate Template { get; set; }

    [JsonPropertyName("submission_events")]
    public required List<GetSubmitterResponseSubmissionEventsItem> SubmissionEvents { get; set; }

    /// <summary>
    /// An array of pre-filled values for the submitter.
    /// </summary>
    [JsonPropertyName("values")]
    public required List<GetSubmitterResponseValuesItem> Values { get; set; }

    /// <summary>
    /// An array of completed or signed documents by the submitter.
    /// </summary>
    [JsonPropertyName("documents")]
    public required List<GetSubmitterResponseDocumentsItem> Documents { get; set; }
