...
public class CreateTemplateFromPdfResponse
{
    /// <summary>
    ...
    public required List<CreateTemplateFromPdfResponseSchemaItem> Schema { get; set; }

    /// <summary>
    /// List of fields to be filled in the template.
    /// </summary>
    [JsonPropertyName("fields")]
    public required List<CreateTemplateFromPdfResponseFieldsItem> Fields { get; set; }

    [JsonPropertyName("submitters")]
    public required List<CreateTemplateFromPdfResponseSubmittersItem> Submitters { get; set; }
    ...
    public required CreateTemplateFromPdfResponseAuthor Author { get; set; }

    /// <summary>
    /// List of documents attached to the template.
    /// </summary>
    [JsonPropertyName("documents")]
    public required List<CreateTemplateFromPdfResponseDocumentsItem> Documents { get; set; }
