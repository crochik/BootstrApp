...
public class CreateSubmissionFromHtmlRequest
{
    ...
    public required List<CreateSubmissionFromHtmlRequestDocumentsItem> Documents { get; set; }

    /// <summary>
    /// The list of submitters for the submission.
    /// </summary>
    [JsonPropertyName("submitters")]
    public required List<CreateSubmissionFromHtmlRequestSubmittersItem> Submitters { get; set; }
