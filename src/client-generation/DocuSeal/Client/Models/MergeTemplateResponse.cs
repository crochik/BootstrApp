...
public class MergeTemplateResponse
{
    ...
    public required List<MergeTemplateResponseSchemaItem> Schema { get; set; }

    /// <summary>
    /// List of fields to be filled in the template.
    /// </summary>
    [JsonPropertyName("fields")]
    public required List<MergeTemplateResponseFieldsItem> Fields { get; set; }

    [JsonPropertyName("submitters")]
    public required List<MergeTemplateResponseSubmittersItem> Submitters { get; set; }
    ...
    public required MergeTemplateResponseAuthor Author { get; set; }

    /// <summary>
    /// List of documents attached to the template.
    /// </summary>
    [JsonPropertyName("documents")]
    public required List<MergeTemplateResponseDocumentsItem> Documents { get; set; }
