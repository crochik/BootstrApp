...
public class CreateSubmissionFromDocxResponseFieldsItem
{
    /// <summary>
    ...
    public CreateSubmissionFromDocxResponseFieldsItemPreferences? Preferences { get; set; }

    /// <summary>
    /// List of areas where the field is located in the document.
    /// </summary>
    [JsonPropertyName("areas")]
    public required List<CreateSubmissionFromDocxResponseFieldsItemAreasItem> Areas { get; set; }
