...
public class CreateSubmissionFromHtmlResponseFieldsItem
{
    /// <summary>
    ...
    public CreateSubmissionFromHtmlResponseFieldsItemPreferences? Preferences { get; set; }

    /// <summary>
    /// List of areas where the field is located in the document.
    /// </summary>
    [JsonPropertyName("areas")]
    public required List<CreateSubmissionFromHtmlResponseFieldsItemAreasItem> Areas { get; set; }
