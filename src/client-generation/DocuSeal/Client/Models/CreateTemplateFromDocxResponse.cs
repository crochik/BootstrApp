...
public class CreateTemplateFromDocxResponse
{
    /// <summary>
    ...
    public required List<CreateTemplateFromDocxResponseSchemaItem> Schema { get; set; }

    /// <summary>
    /// List of fields to be filled in the template.
    /// </summary>
    [JsonPropertyName("fields")]
    public required List<CreateTemplateFromDocxResponseFieldsItem> Fields { get; set; }

    [JsonPropertyName("submitters")]
    public required List<CreateTemplateFromDocxResponseSubmittersItem> Submitters { get; set; }
    ...
    public required CreateTemplateFromDocxResponseAuthor Author { get; set; }

    /// <summary>
    /// List of documents attached to the template.
    /// </summary>
    [JsonPropertyName("documents")]
    public required List<CreateTemplateFromDocxResponseDocumentsItem> Documents { get; set; }
