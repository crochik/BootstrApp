...
public class GetTemplateResponse
{
    ...
    public required List<GetTemplateResponseSchemaItem> Schema { get; set; }

    /// <summary>
    /// List of fields to be filled in the template.
    /// </summary>
    [JsonPropertyName("fields")]
    public required List<GetTemplateResponseFieldsItem> Fields { get; set; }

    [JsonPropertyName("submitters")]
    public required List<GetTemplateResponseSubmittersItem> Submitters { get; set; }
    ...
    public required GetTemplateResponseAuthor Author { get; set; }

    /// <summary>
    /// List of documents attached to the template.
    /// </summary>
    [JsonPropertyName("documents")]
    public required List<GetTemplateResponseDocumentsItem> Documents { get; set; }
