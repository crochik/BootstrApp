...
public class CloneTemplateResponseFieldsItem
{
    /// <summary>
    ...
    public CloneTemplateResponseFieldsItemPreferences? Preferences { get; set; }

    /// <summary>
    /// List of areas where the field is located in the document.
    /// </summary>
    [JsonPropertyName("areas")]
    public required List<CloneTemplateResponseFieldsItemAreasItem> Areas { get; set; }
