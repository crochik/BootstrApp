...
namespace PI.GTM.API.Client
{
    ...
    public partial class ApiClient
    {
        ...
        public ApiClient()
        {
            Configuration = PI.GTM.API.Client.Configuration.Default;
            RestClient = new RestClient("https://api.getgo.com/G2M/rest");
            RestClient.IgnoreResponseStatusCode = true;
        }

        /// <summary>
        /// Initializes a new instance of the <see cref="ApiClient" /> class
        /// with default base path (https://api.getgo.com/G2M/rest).
        /// </summary>
        /// <param name="config">An instance of Configuration.</param>
        public ApiClient(Configuration config)
        {
            Configuration = config ?? PI.GTM.API.Client.Configuration.Default;
        ...
        public ApiClient(String basePath = "https://api.getgo.com/G2M/rest")
        {
