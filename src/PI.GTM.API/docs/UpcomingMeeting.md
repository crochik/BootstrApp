# PI.GTM.API.Model.UpcomingMeeting
## Properties

Name | Type | Description | Notes
------------ | ------------- | ------------- | -------------
**StartTime** | **DateTime?** | The time the meeting instance will start | 
**LastName** | **string** | The surname of the meeting organizer | 
**AccountKey** | **string** | The key of the company account | 
**PasswordRequired** | **bool?** | Indicates whether a password is required to join the meeting or not | 
