...
using PI.Openphone.Controllers;
using PI.Shared.App;
using PI.Shared.Services;
using PI.Shared.Services.DataProtection;
using Serilog;

namespace PI.Openphone;

public class Program : MicroserviceApp
{
    protected override string Name => "Openphone";
    ...
    protected override void AddServices(IServiceCollection services)
    {
        ...
        services.AddSingleton<IEventHandler, ContactEventHandler>();
        services.AddSingleton<IEventHandler, CallEventHandler>();
