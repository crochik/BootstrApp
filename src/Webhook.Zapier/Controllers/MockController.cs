...
/// pipeline so you can watch a Zap fire end-to-end without a real domain. In a
/// production integration the equivalent call lives in your business code, not an
/// HTTP endpoint.
/// </summary>
[ApiController]
[Route("zapier/mock")]
public sealed class MockController : ControllerBase
{
    ...
    /// <summary>Generates a sample payload for the object/event and delivers it to subscribers.</summary>
    [HttpPost("emit")]
