...
Consumed by [`src/Zapier`](../Zapier/README.md), [`src/N8n`](../N8n/README.md) and the generic
[`src/Webhooks`](../Webhooks/README.md), which add only their platform-shaped controllers.
