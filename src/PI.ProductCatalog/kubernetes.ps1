...
# --------------------------------------------------------------
$DEPLOYMENT="staging/apps/productcatalog/deployment.yml"
$JOBTEMPLATES = @(
    "staging/apps/productcatalog/job_b2bsync.yml",
    "staging/apps/productcatalog/job_breadcrumbs.yml",
    "staging/apps/productcatalog/job_keydates.yml",
    "staging/apps/productcatalog/job_upgradeitems.yml"
)
$APP="productcatalog"
