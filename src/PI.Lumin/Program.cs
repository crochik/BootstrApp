...
{
    protected override string Name => "Lumin";
    ...
    protected override void AddServices(IServiceCollection services)
    {
        ...
        services
            .AddSingleton<LuminService>()
            .AddSingleton<ILeadConversionIntegrationService, LuminService>()
    ...
    protected override void AddPolicies(AuthorizationOptions options)
    {
        ...
        // partner (wescheduleit)
        options.AddPolicy("lumin", policy => policy
            .RequireClaim(JwtClaimTypes.ClientId, "Lumin")
            .RequireClaim(JwtClaimTypes.JwtId)
            .RequireClaim("client_account_id")
            .RequireScope("partner")
        );

        options.AddPolicy("lumin-lead", policy => policy
            .RequireClaim(JwtClaimTypes.ClientId, "Lumin")
            .RequireClaim(JwtClaimTypes.JwtId)
            .RequireClaim("client_account_id")
