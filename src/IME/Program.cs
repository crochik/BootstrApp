...
{
    protected override string Name => "IME";
    ...
    protected override void AddServices(IServiceCollection services)
    {
        ...
        services.Configure<Config>(Configuration.GetSection("IME"));

        AddLifetimeService<NotificationProcessor>(services);

        services.AddLeadBuilderService();
    }
